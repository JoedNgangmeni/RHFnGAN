...
myForest.regressionRuns('RF', 'reg', allDatasets, regDatasets, ESTNUM, DEPTH, MAX_RUNS, rawTRFDataPath, aggTRFDataPath)
print('\nregression runs complete...\n')

print('\nstarting classification runs...\n')
myForest.classificationRuns('RF', 'cls', allDatasets, clsDatasets, ESTNUM, DEPTH, MAX_RUNS, rawTRFDataPath, aggTRFDataPath)
